...
data_dir = "/desktop/MSc_Writing/ASLO_2019_Paper/runs_ac_matrices/4layers/5time/"
data_train = "_train"
data_valid = "_test"
...
save_dir = "/desktop/MSc_Writing/ASLO_2019_Paper/runs_ac_matrices//4LayerCM/save_dir"
...
def confusion_matrix(sess, data_type=2):
    ...
    # Omitted by LMacNeil plt.title('Problem: Hologram Confusion Matrix')
    plt.colorbar()
    plt.ylabel('True')
...
W_fc1 = weight_variable([8 * 8 * 256, 1024],'fully_connected_1')
